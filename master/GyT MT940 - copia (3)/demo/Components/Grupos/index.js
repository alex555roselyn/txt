...
<Table columns={columns} rowSelection={rowSelection} dataSource={tab3} />
				...
				<Modal title="Crear Grupo" visible={this.state.crearVisible} okText="Crear" width={900} cancelText="Cancelar" onCancel={this.cerrarModalCrear} onOk={this.sendmessage}>
<Row>
