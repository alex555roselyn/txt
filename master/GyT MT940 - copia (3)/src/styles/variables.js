...
// Dark sidebar
export const sidebarDarkBg = '#003566';
...
export const sidebarLightHoverBg = tinycolor('#ffffff').lighten(1.5).toString();
...
export const logoVariant = (
  ...
  logoHover: tinycolor('#440808').darken(1).toString(),
});
