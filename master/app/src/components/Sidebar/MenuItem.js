...
const StyledLink = styled.a`
  ...
  color: '#fff' !important; /* left border - none in submenu */border-left: ${props => (!props.level ? props.theme.sidebarLinkBorderLeft : 'none')};
  /* transition */
  ...
  ${props => (props.active || props.hover) && `color: ${props.theme.sidebarLinkActiveColor || '#fff'} !important;
