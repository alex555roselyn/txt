...
cerrarModalCrear(){
	try{
		this.setState({crearVisible:false, value2: null,
					 value: undefined});
...
message.warning("Ingrese Nombre y Apellido");
...
{
	message.warning("Ingrese los Datos Requeridos");
}
else{
confirm({
				title: 'Enviar mensaje',
				content: 'Desea crear el contacto '+this.state.value+' '+this.state.value2+'?',
				okText: 'Si',
				okType: 'danger',
				cancelText: 'No',
				onOk() {
...
&nbsp;<Button onClick={this.showagregar}>Nuevo</Button>&nbsp;<Button onClick={this.desactivarphone}>Desactivar</Button>&nbsp;<Button onClick={this.activarphone}>Activar</Button>
       ...
       />
				...
				<Modal title="Crear Contacto" visible={this.state.crearVisible} okText="Crear" width={900} cancelText="Cancelar" onCancel={this.cerrarModalCrear} onOk={this.Okconfirm}>
<Row>
